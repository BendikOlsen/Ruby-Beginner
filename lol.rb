...
factions = ['Bandle City', 'Bilgewater', 'Demacia', 'Freljord', 'Ionia', 'Noxus', 'Piltover', 'Zaun','Shurima', 'void', 'Celestial', 'Kumunggu jungle']
spillere = ['Alexander', 'Bendik', 'Chris', 'Kim', 'Petter', 'Simen']
